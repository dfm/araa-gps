...
\begin{figure}[ht]
  ...
  \end{minipage} \hfill
  \begin{minipage}[t]{0.48\linewidth}
    \includegraphics[width=\linewidth,vshift=1cm]{figures/quasar_posteriors.pdf}
  \end{minipage}
...
\begin{figure}[ht]
  \centering
  \begin{minipage}[t]{0.48\linewidth}
    \includegraphics[align=c,width=\linewidth,vshift=1cm]{figures/transit.pdf} 
  \end{minipage} \hfill
  \begin{minipage}[t]{0.48\linewidth}
    \includegraphics[align=c,width=\linewidth,vshift=1cm]{figures/transit_posteriors.pdf}
  \end{minipage}
