...
\begin{figure}[h]
  ...
  \begin{minipage}[t]{0.48\linewidth}
    \includegraphics[width=\linewidth,vshift=1cm]{quasar_lc.pdf} 
  \end{minipage} \hfill
  \begin{minipage}[t]{0.48\linewidth}
    \includegraphics[width=\linewidth,vshift=1cm]{transit_lc.pdf}
  \end{minipage}
...
\begin{figure}[h]
  \centering
  \begin{minipage}[t]{0.48\linewidth}
    \includegraphics[align=c,width=\linewidth,vshift=1cm]{quasar_posteriors.pdf} 
  \end{minipage} \hfill
  \begin{minipage}[t]{0.48\linewidth}
    \includegraphics[align=c,width=\linewidth,vshift=1cm]{transit_posteriors.pdf}
  \end{minipage}
...
\begin{aaramarginnote}[]
  \entry{Kernel function}{The ``kernel'' or ``covariance'' function, typeset here as $k(t_i,\,t_j;\,\phi)$ is a parametric description of the covariance between two data points $t_i$ and $t_j$. The parameter $\phi$ indicates that these functions are typically parameterized by a set of parameters, typically referred to as ``hyperparameters''.}
\end{aaramarginnote}

\begin{aaramarginnote}[]
  \entry{Hyperparameters}{In a GP model, the kernel function is typically parameterized by a set of parameters that we will label as $\phi$ and refer to as ``hyperparameters''. This label is used to distinguish these parameters from the parameters of the mean function, which we will refer to as $\theta$.}
\end{aaramarginnote}
